...
public struct Vector2
{
    ...
    {
        if (System.Math.Abs(x - other.x) < 0.0001f && System.Math.Abs(y - other.y) < 0.0001f) return true;
    ...
    {
        if (obj is Vector2 other) return Equals(other);
    ...
    {
        return Mathematics.Normalize(this);
    }

    public float LengthSquared()
    {
        return Mathematics.LengthSq(this);
    }
}